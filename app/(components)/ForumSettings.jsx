    ...
    <table className="min-w-full leading-normal">
        ...
        <tbody>
            ...
            <tr>
              ...
              <td className="px-5 py-5 border-b border-gray-200 bg-white text-sm">
                  <input type="color" name="backgroudColor" value={data.backgroudColor} onChange={handleChange} />                 
              </td>
            </tr>
            ...
            <tr>
              ...
              <td className="px-5 py-5 border-b border-gray-200 bg-white text-sm">
                  <input type="color" name="elements1Color" value={data.elements1Color} onChange={handleChange} />                 
              </td>
            </tr>
            ...
            <tr>
              ...
              <td className="px-5 py-5 border-b border-gray-200 bg-white text-sm">
                  <input type="color" name="elements2Color" value={data.elements2Color} onChange={handleChange} />                 
              </td>
            </tr>
