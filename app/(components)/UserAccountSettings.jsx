    ...
    <div className='rounded-xl border p-5 shadow-md bg-white'>
      ...
      {editMode == "name" ? 
        <div className='flex justify-center'>
          <form method="post" onSubmit={handleEditUserName} className="w-full max-w-5xl bg-white rounded-lg px-4 pt-2">
            <div className="flex flex-wrap -mx-3 mb-6">
              <h2 className="px-4 pt-3 pb-2 text-gray-800 text-lg">Zmiana nazwy użytkownika</h2>
              <div className="w-full md:w-full px-3 mb-2 mt-2 flex">
                <input 
                  ...
                  id="title" type='text' name="title" onChange={(e)=>{setUserName(e.target.value)}} value={userName}
      ...
      {editMode == "email" ? 
        <div className='flex justify-center'>
          <form method="post" onSubmit={handleEditUserMail} className="w-full max-w-5xl bg-white rounded-lg px-4 pt-2">
            <div className="flex flex-wrap -mx-3 mb-6">
              <h2 className="px-4 pt-3 pb-2 text-gray-800 text-lg">Zmiana adresu email</h2>
              <div className="w-full md:w-full px-3 mb-2 mt-2 flex">
                <input 
                  ...
                  id="title" type='text' name="title" onChange={(e)=>{setUserMail(e.target.value)}} value={userMail}
                  placeholder='Nowy email'
                  />
                  <input className='bg-white text-gray-700 font-medium mx-1 p-2 border border-gray-400 rounded-lg tracking-wide mr-1 hover:bg-gray-100' type='submit' name="submit" value="Dodaj" />
              </div>
            </div>
          </form>
        </div>
